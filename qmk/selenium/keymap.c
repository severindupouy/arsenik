...
// options in config.h. See arsenik.h for the thumb key definitions.
// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_base] = ONEDEADKEY_LAYOUT(
        ...
        KC_ENT,   KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,        KC_Y,  KC_U,   KC_I,     KC_O,    KC_P,     KC_MPLY,
    ...
    [_symbols] = ONEDEADKEY_LAYOUT(
        ...
        __,  AS(TILD),  AS(LBRC),  AS(RBRC),  AS(UNDS),  AS(HASH),        AS(PIPE),  AS(EXLM),  AS(SCLN),  AS(COLN),  AS(QUES),  __,
                                  ...
                                  SYM_NUM_LAYER,  KC_SPC,  KC_ENT,        __,  KC_RALT,  __
    ),
    ...
    [_vim_nav] = ONEDEADKEY_LAYOUT(
        ...
        __,  SC_UNDO,  SC_CUT,    SC_COPY,     SC_PASTE,    SC_REDO,        XX,       XX,       XX,       XX,       XX,      __,
                     ...
                     KC_CAPS,  LT(_function, KC_DEL),  MO(_num_row),        __,  MO(_function),  KC_RALT
    ),
    ...
    [_num_nav] = ONEDEADKEY_LAYOUT(
        ...
        __,  SC_UNDO,  SC_CUT,   SC_COPY,  SC_PASTE,  SC_REDO,        AS(COMM),       AS(1),  AS(2),  AS(3),  AS(DOT),   __,
                  ...
                  KC_CAPS,  LT(_function, KC_DEL),  S(KC_TAB),        KC_ESC,  LT(_mouse_layer, KC_SPC),  KC_RALT
    ),
    ...
    [_function] = ONEDEADKEY_LAYOUT(
        ...
        __,  KC_F5,  KC_F6,   KC_F7,   KC_F8,   C(AS(D)),          S(KC_LEFT),   LALT_T(KC_MPLY),  RCTL_T(KC_MUTE),  KC_RGUI,  KC_PSCR,  __,
